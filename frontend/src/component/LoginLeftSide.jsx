...
const LoginLeftSide = () => {
  return (
    <div className='hidden md:flex w-1/2 bg-mauve-600
     relative overflow-hidden border-r border-slate-200'>

        <div className='absolute -top-30 -left-30 w-72 h-72
        bg-mauve-300/25 rounded-full blur-3xl'></div>

        <div className='relative z-10 flex flex-col item-start
        justify-center p-12 lg:p20 w-full h-full'>
